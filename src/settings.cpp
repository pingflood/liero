...
, screenSync(true)
{
	...
	wormSettings[0].controls[4] = 42; // FIRE Y lshift
	wormSettings[0].controls[5] = 57; // CHANGE X space
	wormSettings[0].controls[6] = 56; // JUMP B lalt
